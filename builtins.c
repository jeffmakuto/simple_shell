 ...
 *
 * @args: An array of command arguments where args[1] contains the target directory path.
 *
 ...
 * If the argument is "-", it changes the directory to the previous directory.
 * The function also updates the OLDPWD environment variable and displays the new path.
 *
 * Return: Void
 */
